...
export const icons = {
  logo: SVG('<path d="M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8Z"/><path d="M15 3v4a2 2 0 0 0 2 2h4"/>'),
  notes: SVG('<path d="M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8Z"/><path d="M15 3v4a2 2 0 0 0 2 2h4"/><path d="M10 12h4"/><path d="M10 16h4"/>'),
  ...
  user: SVG('<circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/>'),
  ...
  archive: SVG('<rect x="2" y="4" width="20" height="5" rx="2"/><path d="M4 9v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9"/><path d="M10 13h4"/>'),
  restore: SVG('<path d="M4 14v3a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-3"/><polyline points="16 9 12 5 8 9"/><line x1="12" y1="5" x2="12" y2="14"/>'),
};

export function icon(name, extraClass = '') {
  const svg = icons[name] || '';
  return `<span class="icon ${extraClass}">${svg}</span>`;
}
